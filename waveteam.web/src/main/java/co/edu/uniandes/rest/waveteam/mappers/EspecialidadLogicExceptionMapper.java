 ...
 */ 
@Provider
public class EspecialidadLogicExceptionMapper implements ExceptionMapper<EspecialidadLogicException>{
     ...
     */
    @Override
    public Response toResponse(EspecialidadLogicException ex) {
